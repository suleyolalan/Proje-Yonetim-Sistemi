...
// Tüm projeleri getir - DÜZELTİLDİ
...
// Yeni proje ekle - DÜZELTİLDİ
//app.post('/api/projects', async (req, res) => {
//   try {
//        const { ad, aciklama, baslangic_tarihi, bitis_tarihi, durum, butce, proje_yoneticisi_id } = req.body;
        
//        const result = await pool.query(
//            'INSERT INTO projeler (ad, aciklama, baslangic_tarihi, bitis_tarihi, durum, butce, proje_yoneticisi_id) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING *',
//            [ad, aciklama, baslangic_tarihi, bitis_tarihi, durum, butce, proje_yoneticisi_id]
//        });
...
app.listen(PORT, () => {
    ...
    console.log(`API: http://localhost:${PORT}/api/project-assignments`);
});